...
class EmailConfig {
  ...
  static List<Widget> signInviteCode(Function(int type, String text) callBack,
      int type, TextEditingController inviteCodeController) {
    List<Widget> list = [];
    if (ConfigStore.to.isOpenEmail()) {
      list = [
        16.horizontalSpace,
        Expanded(
          child: AppButton.brandPrimaryButton(LocaleKeys.text_0033.tr, () {
